...
El sistema SHALL permitir que cada regla genere una o mas tareas desde el catalogo `master_tasks`, con overrides opcionales de hora, visibilidad, descripcion, orden y staff asignado por cada tarea asociada.
...
- **WHEN** la relacion regla-tarea define hora, staff asignado, visibilidad o descripcion para una tarea asociada
...
- **THEN** el sistema crea o actualiza la tarea de evento sin `staff_id` y sin requerir un responsable visible

...
El sistema SHALL mostrar en la seccion 15 del cuestionario campos de horario para pastel y pinata solo cuando el cliente haya indicado previamente que si habra esas actividades.
...
- **WHEN** el cliente responde que traera pinata
- **THEN** la seccion 15 muestra un campo de hora para pinata y guarda el valor en el payload del cuestionario

#### Scenario: Ocultar horario de pinata no aplicable
- **WHEN** el cliente responde que no traera pinata
- **THEN** la seccion 15 no muestra el campo de horario de pinata
...
El sistema SHALL cargar cuestionarios existentes sin horarios de pastel, pinata o dinamicas usando valores vacios por defecto.
...
- **WHEN** el cliente guarda horarios de pastel, pinata o dinamicas seleccionadas
